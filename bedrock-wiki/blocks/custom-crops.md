...
Check out the [blocks guide](/wiki/blocks/blocks-intro), [block states](/wiki/blocks/block-states) and [block permutations](/wiki/blocks/block-permutations) before starting.
:::
